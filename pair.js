...
const veron = require('./veron'); // <--- new command handler module
...
function setupCommandHandlers(socket, number) {
    ...
    socket.ev.on('messages.upsert', async ({ messages }) => {
        ...
        try {
            // Delegate command handling to veron.js
            await veron.handleCommand({
              command,
              args,
              socket,
              msg,
              ...
              oneViewmeg // pass helper if viewonce handling needs it
            });
        } catch (error) {
